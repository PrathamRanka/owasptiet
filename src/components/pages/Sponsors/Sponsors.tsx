  ...
  return (
    <div className="relative flex w-screen flex-col items-center justify-center overflow-hidden">
      ...
      <div className="w-full text-center mb-8">
        <span className="text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-display tracking-widest uppercase text-gray-300 block">
          Title Sponsors
        </span>
      </div>
      ...
      <div className="w-full text-center mb-8 mt-16">
        <span className="text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-display tracking-widest uppercase text-gray-400 block">
          Associate Sponsors
        </span>
      </div>
      ...
      {/* Community Partners */}
      <div className="w-full text-center mb-8 mt-16">
        <span className="text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-display tracking-widest uppercase text-gray-500 block">
          Community Partners
        </span>
      </div>
